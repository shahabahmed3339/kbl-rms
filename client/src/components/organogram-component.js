                                                        ...
                                                        this.state.ProductData1.map((p) => {
                                                                return  <>
                                                                        ...
                                                                        this.state.ProductData.filter(lvl => lvl.Level===1 && lvl.Department===p.Name).map((p1) => {
                                                                                return  <>
                                                                                        <TreeNode label={<div className="div-1">{p1.Designation}</div>}>
                                                                                        {
                                                                                        this.state.ProductData.filter(lvl => lvl.Level===2 && lvl.Department===p.Name).map((p2) => {
                                                                                                return  <>
                                                                                                        <TreeNode label={<div className="div-1">{p2.Designation}</div>}>
                                                                                                        {
                                                                                                        this.state.ProductData.filter(lvl => lvl.Level===3 && lvl.Department===p.Name).map((p3) => {
                                                                                                                return  <>
                                                                                                                        <TreeNode label={<div className="div-1">{p3.Designation}</div>}>
                                                                                                                        {
                                                                                                                        this.state.ProductData.filter(lvl => lvl.Level===4 && lvl.Department===p.Name).map((p4) => {
                                                                                                                                return  <>
                                                                                                                                        <TreeNode label={<div className="div-1">{p4.Designation}</div>}>
                                                                                                                                        </TreeNode>
                                                                                                                                        </>
                                                                                                                                        })
                                                                                                                        }
