...
export default class Hierarchy extends Component {
  ...
  onSubmit(e) {
    ...
    axios.post('http://localhost:5000/Hierarchy/add', hr)
      ...
      var msg = document.getElementById("submithierarchy")
      msg.textContent="Your Hierarchy is Submitted. Click to "
      const link = document.createElement("a");
    
      link.setAttribute('href', `/organogram`);
      link.textContent = 'Check Organogram';
  ...
  render() {
    return (
      ...
      <UnlockAccess request={'Admin'}>
        ...
        <div className="form-box">
          ...
          <div className="form-group">
            ...
            <UncontrolledCollapse toggler="#toggler1">
                <CardBody>
                  <AddDesignation Department={this.state.Department}/>
                </CardBody>
            </UncontrolledCollapse>
          <div className="form-group"> 
            <label>Level: </label>
        ...
        <div className="alert" id="submithierarchy"></div>
        </form>
      </UnlockAccess>
