...
export default class Verification extends Component {
  ...
  onSubmit(e) {
    ...
    axios.post('http://localhost:5000/ShortList/add', shortlist)
      ...
      var msg = document.getElementById("submitverify")
      msg.textContent="Your Verification is Submitted. Click to "
      const link = document.createElement("a");
    
      link.setAttribute('href', `/selection`);
      link.textContent = 'Selection Process';
  ...
  render() {
    ...
    <UnlockAccess request={'Admin'}>
      ...
      <div className="form-box">
        ...
        <div className="alert" id="submitverify"></div>
      </form>
                </UnlockAccess>
